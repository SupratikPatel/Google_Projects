...
def display_summary() -> None:
    ...
    st.write(generate_summary(file, file.type))
...
therefore they can be inaccurate. Double verify important info.
                </span>
            </div>""")
...
NOTE: Make sure if the question is not relevant to the {file.type} and context \
provided, reply with a very short response in 10 words like 'your question is out of scope.'
"""
